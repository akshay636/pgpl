...
const department =['Automobile Engineering','Mechanical Engineering', 'Civil Engineering', 'Pharmacy', 'IT']
const Dropdown = ({name}) => {
        ...
        >
          <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="multiLevelDropdownButton">
            {department.map((dep)=>(
              ...
              <li>
              <a href="#" className=" text-xs block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                {dep}
              </a>
            </li>
            ))}
